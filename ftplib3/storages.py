...
from ftplib3.connection import FTPConnection

SUPPORTED_SCHEMES = ('ftp', 'ftps', 'aftp', 'aftps')

class FTPStorageException(Exception):
    pass


class BaseFTPStorage(Storage):
    """FTP Storage class for Django pluggable storage system."""
    ...
    def _decode_location(self, location):
        ...
        if splitted_url.scheme not in SUPPORTED_SCHEMES:
...
class AFTPStorage(BaseFTPStorage):
    pass

class AFTPSStorage(BaseFTPStorage):
    pass
